<template>
    <AppLayout title="Editar Grupo de Permissões">
        <div class="py-6">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-900">Editar Grupo: {{ role.name }}</h1>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="border rounded-lg p-4">
                                    ...
                                    <div class="grid grid-cols-4 gap-2 ml-6">
                                        <label v-for="acao in acoesBasicas" :key="acao" class="flex items-center">
                                            <input
                                                type="checkbox"
                                                :value="`clientes.${acao}`"
                                ...
                                <div class="border rounded-lg p-4">
                                    ...
                                    <div class="grid grid-cols-5 gap-2 ml-6">
                                        <label v-for="acao in acoesPropostas" :key="acao" class="flex items-center">
                                            <input
                                                type="checkbox"
...
const acoesBasicas = ['view', 'create', 'edit', 'delete'];
const acoesPropostas = ['view', 'create', 'edit', 'delete', 'fechar'];
...
const submit = () => {
    form.put(`/permissoes/${props.role.id}`);
};
</script>
