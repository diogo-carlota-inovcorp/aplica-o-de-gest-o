<template>
    <AppLayout title="Editar Proposta">
        <div class="py-6">
            <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-900">Editar Proposta</h1>
                    <a href="/propostas" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                        Voltar
                    </a>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg p-6">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Data Proposta *</label>
                                <input type="date" v-model="form.data_proposta" class="w-full rounded-md border-gray-300 px-3 py-2" required />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Validade *</label>
                                <input type="date" v-model="form.validade" class="w-full rounded-md border-gray-300 px-3 py-2" required />
                            </div>
                        </div>
                            ...
                            <div v-for="(linha, index) in form.linhas" :key="index" class="border rounded-lg p-4 mb-4">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <select v-model="linha.fornecedor_id" class="w-full rounded-md border-gray-300 px-3 py-2">
                                            <option value="">Selecione...</option>
...
const form = useForm({
    numero: props.proposta.numero,
    data_proposta: props.proposta.data_proposta,
    validade: props.proposta.validade,
    cliente_id: props.proposta.cliente_id,
    linhas: props.proposta.linhas.map(linha => ({
